package webapp.security.access.factory;

import webapp.model.ProjectApplication;
import webapp.security.access.entity.ProjectApplicationPermissionEvaluator;
